...
Следующая задача: `QA-01` — `BLOCKED`: deployed/server evidence готово, но встроенный Browser policy запрещает обязательные final browser-only P1 journeys и запрещает workaround.
