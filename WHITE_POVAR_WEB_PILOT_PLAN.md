...
Следующая задача: `DEPLOY-01` (BLOCKED только на owner-authenticated smoke после deployed corrective fix; в release environment нет test auth token/session)
