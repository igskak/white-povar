...
Следующая задача: `QA-01` — `IN PROGRESS`: deployed P1-fix и Studio rollback drill подтверждены; остаются browser-only critical journeys и финальный completion audit.
...
| 9 | QA-01 | Production smoke, security и rollback verification | DEPLOY-01 | IN PROGRESS |
