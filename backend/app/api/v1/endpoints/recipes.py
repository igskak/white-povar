...
# Accepts both the English unit keys the ingestion pipeline speaks and the
# Ukrainian abbreviations the API hands to the app. An editor that reads a
# recipe and saves it back returns whatever it was shown, so a map that knew
# only English would silently drop the unit on every round trip.
_UNIT_IDS = {
    'g': '00000000-0000-0000-0000-000000000001',
    'г': '00000000-0000-0000-0000-000000000001',
    'kg': '00000000-0000-0000-0000-000000000002',
    'кг': '00000000-0000-0000-0000-000000000002',
    'ml': '00000000-0000-0000-0000-000000000010',
    'мл': '00000000-0000-0000-0000-000000000010',
    'l': '00000000-0000-0000-0000-000000000011',
    'л': '00000000-0000-0000-0000-000000000011',
    'piece': '00000000-0000-0000-0000-000000000020',
    'шт': '00000000-0000-0000-0000-000000000020',
    'cup': '00000000-0000-0000-0000-000000000021',
    'скл.': '00000000-0000-0000-0000-000000000021',
    'tbsp': '00000000-0000-0000-0000-000000000031',
    'ст. л.': '00000000-0000-0000-0000-000000000031',
    'tsp': '00000000-0000-0000-0000-000000000032',
    'ч. л.': '00000000-0000-0000-0000-000000000032',
    'oz': '00000000-0000-0000-0000-000000000041',
    'унц.': '00000000-0000-0000-0000-000000000041',
    'lb': '00000000-0000-0000-0000-000000000051',
    'фунт': '00000000-0000-0000-0000-000000000051',
}
...
def _get_unit_name_from_id(unit_id: str) -> str:
    ...
    # That table only carries name_en/name_it, so there is no Ukrainian column
    # to read from; the app ships a single Ukrainian locale, so the
    # abbreviations are spelled out here rather than served in English.
    unit_mapping = {
        ...
        '00000000-0000-0000-0000-000000000021': 'скл.',
        '00000000-0000-0000-0000-000000000041': 'унц.',
        '00000000-0000-0000-0000-000000000051': 'фунт'
    }
