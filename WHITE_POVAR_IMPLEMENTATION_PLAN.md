...
Дата: 15 июля 2026  
Статус: COL-03 выполнена; consumer-клиент отображает tenant-scoped collections, locked previews и resume последнего материала.
Следующая задача: `COM-01`
