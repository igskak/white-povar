...
Дата: 15 июля 2026  
Статус: COM-02 BLOCKED: реализация и sandbox checklist готовы, но нужны Apple Developer, Google Play Console и RevenueCat accounts для фактической sandbox setup.
