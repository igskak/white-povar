...
Дата: 15 июля 2026  
Статус: COL-02 выполнена; published collections используют tenant-scoped list/detail API, локализованные метаданные и стабильный ordered content contract.
Следующая задача: `COL-03`
